...
let cuenta = {
  ...
  informar() {
    console.log(this);
    document.write(
      `<p class="texto">La cuenta perteneciente a ${this.titular} tiene un balance de ${this.saldo}<br></p>`
    );
  },
};
...
// let cuentaAlex = new Cuenta("Alex", 100);


// cuentaAlex.informar();

// let deposito = parseFloat(prompt(`Ingrese un monto`));
// cuentaAlex.ingresar(deposito);
